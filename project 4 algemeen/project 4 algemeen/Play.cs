...
namespace project_4_algemeen
{
    class Play : gameElement
    {
...

        {
            ...
            Buttons.Add(new button((int)(screen_width * 0.4), (int)(this.screen_height * 0.33), (int)(screen_width * 0.2), (int)(screen_height * 0.1), "Start!", this.Font, this.relativeSize, Color.White, Color.LightGray,  new Switch_level(this.All_images,this.game1,this.screen_width,this.screen_height,this.platform,this.Font,this.graphics, sound), graphics));
