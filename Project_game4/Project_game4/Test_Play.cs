...
{
    class Test_Play : I_Button_classes
    {
        public string name;
        string class_name;
        SpriteFont Font;
        ...
        public Test_Play(string name,SpriteFont Font,int X , int Y ,GraphicsDeviceManager graphics)
        {
            this.name = name;
            this.Font = Font;
            this.X = X;
        ...
        {
            Console.WriteLine("Draw from Test_Play works");
